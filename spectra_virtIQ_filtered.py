...
lowk_filt = calc.notch(lowk.iq, lowk.Fs, inputs['f_notch'], inputs['Q_notch'])
lowk_filt = calc.bandPass(lowk_filt, lowk.Fs, fp=[inputs["fpass_low"], inputs["fpass_high"]], fs=[inputs["fstop_low"], inputs["fstop_high"]])
